  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // bottom sheet by default; tweak as needed
          "fixed inset-x-0 bottom-0 z-50 flex max-h-[80vh] w-full flex-col rounded-t-lg border-t bg-background",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full bg-muted sm:block" />
        {children}
      </DialogPrimitive.Content>
    </DrawerPortal>
  )
